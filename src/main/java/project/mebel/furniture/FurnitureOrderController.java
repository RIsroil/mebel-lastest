...
public class FurnitureOrderController {
    ...
    @Operation(summary = "Buyurtmadan materialni olib tashlash (omborga qaytaradi)")
    public ResponseEntity<FurnitureOrderResponse> removeMaterial(@PathVariable UUID id,
